...
const Navbar = () => {
  ...
  return (
    <div className='h-16 fixed top-0 left-0 w-full flex items-center justify-between px-10 shadow-sm bg-black/30 backdrop-blur-sm '>
      <div className="logo uppercase text-xl font-bold tracking-wider select-none text-white"><span className='text-[rgb(52,168,83)]'>M</span><span className='text-[rgb(251,188,5)]'>E</span><span className='text-[rgb(66,133,244)]'>R</span><span className='text-[rgb(234,67,53)]'>N</span>-Auth-App</div>
